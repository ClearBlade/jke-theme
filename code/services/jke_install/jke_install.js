...
function pxc_install(req, resp) {
  ...
  var brandingData = {
      ...
      config: JSON.stringify([{
          logo: {
              logoUrl: "https://cdn-ilaajhb.nitrocdn.com/bzYtFznvkVaQdGOioMzGqUmNQFhSYZZC/assets/images/optimized/rev-a0e3774/jkconsultingco.wpenginepowered.com/wp-content/uploads/2022/07/JK_Logo_Adjusted-300x104.png"
          },
          title: {
              titleText: "JK Technology Solutions"
          }
      }]),
      description: "Branding Configuration for JK Technology Solutions"
  };
